...
const DownwardChevron = ({ className = "", ...props }) => (
  <svg className={`text-gray-400 -mr-1 size-5 ${className}`} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" dataslot="icon">
